...
function mouseDown(obj,e){
	//点击时添加阴影效果
	document.getElementById("twoBox").style.boxShadow="2px 2px 10px #464646";
...
function mouseUp(e){
	if(isDown){
		...
		isDown = false;
		document.getElementById("twoBox").style.boxShadow="1px 1px 5px #464646";
	}
}
...
function mouseDownM(obj,e){
	//点击时添加阴影效果
	document.getElementById("thrBox").style.boxShadow="2px 2px 10px #464646";
...
function mouseUpM(e){
	if(isDown){
		...
		isDown = false;
		document.getElementById("thrBox").style.boxShadow="1px 1px 5px #464646";
	}
}